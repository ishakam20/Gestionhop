    ...
    <body>
        <nav>
			<ul>
                ...
                <li><a href="autrespatients.php">Autres patients</a></li>
        ...
        <main class="main">
            ...
            <p><span><a href="rapportmedsec1.php?d=<?=$id?>" > Rapport Médical</a></span> </p>
        </main>
        <?php }else{ ?> 
            <main class="main">
            <p><span>ID : <?php echo $data_pat['idPatient'] ?> </span> </p>
            ...
            <p><span>NUMERO DE TELEPHONE 01 :</span> <?php echo $data_pat['tel1'] ?> </p>
            <p><span>GROUPE SANGUIN :</span> <?php echo $data_pat['grp-sanguin'] ?> </p>
            <p><span><a href="rapportmedsec2.php?d=<?=$id?>"> Rapport Médical</a></span> </p>
        </main>
        <?php } ?>
    </body>
</html>
