<?php 
    ...
    $option = 0;
    $encryption_key = "Iv39eptJvuhAq5srTo7mFqiZcuwXq1n0";      // Il va transformer la clé en code ascii
    $encryption_iv = "1234567890123456";
    $taille = ($_POST['taille']);
    $taillec = openssl_encrypt($taille,$ciphering,$encryption_key,$option,$encryption_iv); // il va transformer la taille en code ascii
    $poids = ($_POST['poids']);
