...
<html>
	...
	<head>
		...
		<meta charset="UTF-8" />
		<link rel="stylesheet" href="infosmed.css" type="text/css"/>
	</head>
	<body>
		<nav>
			<ul>
                    ...
                    <div class="col-lg-6 col-md-6 form-container">
                        <div class="col-lg-8 col-md-12 col-sm-9 col-xs-12 form-box text-center">
                            <div class="heading mb-3">
                                <h1> Consultation les informations medicalles des patients </h1>
                            </div>
                            <br/>
                            <form action="consulterrap.php" method="POST" >
