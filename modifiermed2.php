...
<html>
    <head>
        ...
        <meta charset="UTF-8" />
		<link rel="stylesheet" href="modifiermed2.css" type="text/css"/>
    </head>
    <body>
        <nav>
			<ul>
        ...
        <main class="main">
        <form method="POST" action="update2.php?idc=<?=$id?>">
        <label  for="tp"> Taille :</label>
            ...
            <input type="number" id="tension" value= <?php echo $tensiond?> name="tens" min="0" max="22" /><br/>
            <label  for="mc"> Maladies Chroniques :</label><br/>
            <textarea id="mc" name="mc" rows="5" cols="40"><?php echo $mald ?> </textarea><br/>
