...
<html>
    ...
    <body>
        ...
        <main class="main">
            ...
            <p><span><a <?php if( $data_hop['wilaya'] < 30 ) { ?> href="rapportmed1.php?d=<?=$id?>" <?php }else{ ?>href="rapportmed2.php?d=<?=$id?>"<?php } ?> > Rapport Médical</a></span> </p>
            <p><span><a <?php if( $data_hop['wilaya'] < 30 ) { ?> href="ajouterrap1.php?d=<?=$id?>" <?php }else{ ?>href="ajouterrap2.php?d=<?=$id?>"<?php } ?> > Ajout de consultaiton</a></span> </p>
        </main>
    </body>
</html>
